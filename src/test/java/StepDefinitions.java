...
public class StepDefinitions {
    ...
    public void the_http_status_code_of_the_response_should_be(Integer statusCode) {
        given()
                .when()
    ...
    public void the_response_time_should_be_below_milliseconds(Integer responseTime) {
        given()
                .when()
                .get("https://testapi.io/api/ottplatform/media")
                .then()
                .time(lessThan(Long.valueOf(responseTime)));
